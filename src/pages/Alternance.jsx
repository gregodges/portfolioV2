      ...
      <div className="alternance__faq">
        <div className="alternance__Q">
          ...
          <p className="alternance__answers">
            ...
            {' '}
            <a className="sarah" href="mailto:sarah.souini@wildcodeschool.com ">Sarah Souini</a>
        ...
        <div className="alternance__source">
          ...
          <ul className="alternance__source__ul">
            <li>
              OPCO :
              <a target="_blank" href="https://travail-emploi.gouv.fr/ministere/acteurs/partenaires/opco">https://travail-emploi.gouv.fr/ministere/acteurs/partenaires/opco</a>
            </li>
            <li>
              {' '}
              Pole Emploi :
              <a target="_blank" href="https://www.pole-emploi.fr/employeur/aides-aux-recrutements/les-aides-a-lembauche/aide-a-lembauche-dun-demandeur-d.html">Aide à l'embauche.</a>
            </li>
            <li>
              Wild Code School :
              <a target="_blank" href="https://www.wildcodeschool.com/fr-FR/formations/formation-developpeur-web-alternance">https://www.wildcodeschool.com/fr-FR/formations/formation-developpeur-web-alternance</a>
            </li>
