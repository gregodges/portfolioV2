  ...
  return (
    <div className="hobbies">
      ...
      <section className="hobbies__panel">
        ...
        <img className="hobbies__panel__photo photo2 photoFast" src="src/assets/img/CNV000007.jpg" alt="" /> // ici
      ...
      <section className="hobbies__panel">
        ...
        <img className="hobbies__panel__photo photo6 photoMid" src="src/assets/img/000008.JPG" alt="" />
      </section>
