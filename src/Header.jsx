  ...
  return (
    <div className="header">
      ...
      <p className="header__description">
        ...
        Je m'appelle Greg, je suis developpeur web fullstack, en formation à la
        <span className="header__description-wild">Wild Code School</span>
        .
        Je recherche une
        <NavLink to="/infoalternance">
          {' '}
          <span className="header__description-alternance">alternance</span>
          {' '}
        </NavLink>
        {' '}
