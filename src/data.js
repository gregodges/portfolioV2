...
export const XPProMain =[
  ...
  },
  {
    ...
    txt:"Norwegian est la 5 ème plus grande compagnie aérienne à bas prix au monde et a été nommée la meilleure compagnie aérienne long- courrier low-cost au monde plusieurs années de suite. Mes missions principales étaient: - Essais techniques et vérifications de la cabine : présence et fonctionnement du matériel médical, de sécurité et de communication - Accueil et assistance aux passagers- Responsabilité du bon déroulement du vol : contrôle régulier de la cabine et remontée d’alerte en cas de situation inhabituelle",
...
export const XPProSub = [
{
  ...
  years :"2017",
  skills: ['Écoute client', "Communication","Send du détail" ]
},
{
  id:2,
